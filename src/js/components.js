    ...
    result: /*html*/`
        <main class="w-full h-full bg-large bg-contain flex items-center flex-col caveat-font p-4 gap-10 md:gap-12 overflow-y-scroll">
            <div class="flex flex-col items-center">
                ...
                <h2 class="md:text-7xl text-4xl">Secante Inversa Hiperbólica</h1>
            ...
            <ul class="w-5/6 md:h-72 flex gap-10 flex-col md:flex-wrap my-10">
                <li class="md:w-4/12 w-full h-full flex flex-col items-center text-4xl">
